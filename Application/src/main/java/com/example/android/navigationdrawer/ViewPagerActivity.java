...
public class ViewPagerActivity extends ActionBarActivity {
    ...
    static ArrayList<ContentItem> getSampleContent() {
        ...
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "myclass.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "class2.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "jam.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "jam2.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "love.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "mom1.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "mom2.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "co.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_TEXT, R.string.quote_3));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "gwan.jpg"));
